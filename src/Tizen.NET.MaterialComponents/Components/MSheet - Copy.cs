...
{
    public class MSheet : MBox, IColorSchemeComponent
    {
        Window _window;
        ...
        // isopen direction, toggled


        public MSheet(EvasObject parent, SheetDirection direction = SheetDirection.Side) : base(parent)
        {
